...
export default function Post() {
  return (
    <>
      <Head>
        <title>teste | spacestraveling</title>
      </Head>

      <Header />

      <div className={styles.imageBanner}>
        <img src="http://source.unsplash.com/random" alt="random img" />
      </div>
      ...
      <main className={commonStyles.container}>
        <article className={styles.post}>
          ...
          <div className={styles.infoContent}>
            <time>
              <FiCalendar /> 30 Mar 2021
            </time>

            <span className={styles.infoAuthor}>
              <FiUser /> Vinicius Oliveira
            </span>
          ...
          <div className={styles.content}>
            ...
            et sapien. Cras in erat rhoncus, dignissim ligula iaculis, faucibus
